...
function addScore(tilesToDelete) {
	//добавить получение очков равное количеству удаляемых элементов и вывести его в тег span с индексом scores
	document.getElementById("scores").innerText = scores += tilesToDelete.length;
}